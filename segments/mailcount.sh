...
TMUX_POWERLINE_SEG_MAILCOUNT_THUNDERBIRD_MAILBOX_PATHS="${TMUX_POWERLINE_SEG_MAILCOUNT_THUNDERBIRD_MAILBOX_PATHS:-${HOME}/.thunderbird/XXX.default-release/ImapMail/imap.exmaplemail.com}"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_THUNDERBIRD_MAILBOX_PATHS="${TMUX_POWERLINE_SEG_MAILCOUNT_THUNDERBIRD_MAILBOX_PATHS}"
EORC
	echo "${rccontents}"
}
